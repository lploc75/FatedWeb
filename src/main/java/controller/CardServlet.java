...
public class CardServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getSession().setAttribute("cardImage", randomCard.getImageUrl());
        request.getSession().setAttribute("cardDescription", randomCard.getDescription());
        try {
            Thread.sleep(2000); // Chờ 2 giây (2000 milliseconds)
